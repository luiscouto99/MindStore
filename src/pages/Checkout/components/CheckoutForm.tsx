...
export const CheckoutForm = ({handleSubmit, handleInputTyped, number, name, date, cvv} : {handleSubmit: () => void, handleInputTyped: () => void, number: string, name: string, date: string, cvv: string}) => {
    return (
