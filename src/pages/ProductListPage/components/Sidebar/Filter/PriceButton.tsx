        ...
        <SidebarForm>
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject01)}
              value={priceObject01}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject02)}
              value={priceObject02}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject03)}
              value={priceObject03}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject04)}
              value={priceObject04}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject05)}
              value={priceObject05}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject06)}
              value={priceObject06}
            />
          ...
          <SidebarLabel>
            <SidebarInput
              type="radio"
              name="price"
              onChange={() => handlePriceChange(priceObject07)}
              value={priceObject07}
            />
