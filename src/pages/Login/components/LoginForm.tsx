...
export const LoginForm = ({ handleSubmit, loginSuccessful, email, password, message }: { handleSubmit: () => void, loginSuccessful: boolean, email: string, password: string, message: string }) => {
    return (
        <CredentialsLayout>
