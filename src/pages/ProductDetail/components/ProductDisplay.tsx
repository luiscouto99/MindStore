...
export const ProductDisplay = ({productsToAdd, productData, userId, handleAddToUserCart, handleAddToUserCartFetch} : {productsToAdd: number, productData: Product, userId: number, handleAddToUserCart: () => void, handleAddToUserCartFetch: () => Promise<void>}) => {
    return (
        <>
            {productData && (
                <ProductContainer>
